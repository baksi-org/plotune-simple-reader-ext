...
echo "=================================================="
echo "Plotune Simple Reader Extension Builder (Linux)"
echo "=================================================="

APP_NAME="plotune_simple_reader_ext"
ARCHIVE_NAME="plotune-simple-reader-ext-linux-x86_64.tar.gz"
DIST_DIR="dist"
...
p = Path("dist/plotune_simple_reader_ext/plugin.json")

data = json.loads(p.read_text(encoding="utf-8"))
data["cmd"] = ["./plotune_simple_reader_ext"]
...
cd "$DIST_DIR"
tar -czf "$ARCHIVE_NAME" -C "$APP_NAME" .
